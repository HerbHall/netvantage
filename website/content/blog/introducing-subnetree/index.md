...
SubNetree is a modular, self-hosted network monitoring and management platform -- and today we're making it public.
...
SubNetree combines five capabilities into a single self-hosted application:
...
SubNetree is in **Phase 1: Foundation**. Here's what's implemented:
...
This means individual users and small businesses can use SubNetree freely, while the project maintains a sustainable path for commercial development.

## Get Involved

- **Star the repo**: [github.com/HerbHall/subnetree](https://github.com/HerbHall/subnetree)
- **Report issues**: [Issue tracker](https://github.com/HerbHall/subnetree/issues)
...
We're building SubNetree in the open and welcome feedback at every stage. If you manage networks and want a unified, self-hosted solution, we'd love to hear from you.
