...
Have an idea for SubNetree? We'd love to hear it.

## Before Requesting

1. **Check the roadmap** -- your idea may already be planned. See the [Roadmap](/#roadmap) for upcoming phases.
2. **Search existing issues** -- check [open issues](https://github.com/HerbHall/subnetree/issues) for similar requests
3. **Review the requirements** -- detailed planning docs are in [docs/requirements/](https://github.com/HerbHall/subnetree/tree/main/docs/requirements)

## How to Request

Use the [Feature Request template](https://github.com/HerbHall/subnetree/issues/new?template=feature_request.md) on GitHub.
...
SubNetree has a plugin architecture. Consider whether your request:
...
Plugin requests can often be implemented independently using the [Apache 2.0 licensed Plugin SDK](https://github.com/HerbHall/subnetree/tree/main/pkg/plugin).
